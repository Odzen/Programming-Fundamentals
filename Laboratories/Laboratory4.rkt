...
;------------------------------------------------------------------------------------------------------------------------------
; Punto 4
; mayor-persona: persona persona -> persona
; Compara la fecha de nacimiento de dos personas y devuelve la persona de
; mayor edad. Si estos cumplen anos el mismo dia se retorna un
; display que lo indica. La comparacion se empieza por los anos de
...
; dentro de un rectangulo, esto se determina mediante intervalos
...
; Se necesita para determinar la distancia entre dos puntos
...
;------------------------------------------------------------------------------------------------
;Se definen el entro y el radio de un circulo
...
; Determinar si un rectangulo se sobrelapa con un circulo
; Para esto se plantean los distintos casos en los cuales se sobrelapan
; se utiliza punto-contenido? como recurso para determinar un caso
; el otro caso se desarrolla por medio de calculo de distancias
